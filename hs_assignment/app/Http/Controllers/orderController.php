...
class orderController extends Controller
{
    ...
    public function getDistanceFromGoogleMap($pickup, $dropoff)
    {
        $curl = curl_init();
        curl_setopt_array(
            $curl,
    ...
    public function addorder(Request $request)
    {
        ...
        if (isset($request->drop_cord) && (!is_null($request->drop_cord))) {
            ...
            try {
                $data = $this->getDistanceFromGoogleMap($request->pick_cord, $request->drop_cord);
        ...
        $order->pickup_address = $request->pick_address;
        $order->pickup_coordinates = $request->pick_cord;
        $order->dropoff_address = $request->drop_address;
